...
> ⚠️ This snake animation needs to be generated by a GitHub Action in your own repo (see [`platane/snk`](https://github.com/Platane/snk)) — it won't render until you set that workflow up.
